//This is an old file, that is no longer utilized, and can be ignored
...
const convertDataForAccounting = (product) => {
    ...
    const allUpperCase = upperDescription + " - " + upperPrice + " - " + upperType
    return allUpperCase
}
...
for (let data of inventory) {
    const modifiedData = convertDataForAccounting(data)
